...
#PBS -W umask=017
#PBS -q normal
#PBS -l walltime=4:00:00,mem=10GB,jobfs=50GB,other=pernodejobfs
#PBS -l wd
...
INPUT_DIR='/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2020/2020-03/'
...
for i in $(seq  $START $END);
    ...
    do echo 2020-03-$i 2020-03-$(($i+1)) $INPUT_DIR $OUTPUT_DIR ;
